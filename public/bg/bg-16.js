...
var fov = 75,
container = document.getElementById( 'bg-16' );
...
window.addEventListener('resize',function() {
	renderer.setSize( container.offsetWidth, container.offsetHeight );
	tuniform.resolution.value.x = renderer.domElement.width;
	tuniform.resolution.value.y = renderer.domElement.height;
});

tuniform.resolution.value.x = container.offsetWidth;
tuniform.resolution.value.y = container.offsetHeight;
// Create Plane
...
var mesh = new THREE.Mesh(
	new THREE.PlaneBufferGeometry(container.offsetWidth, container.offsetHeight, 40), material
);
scene.add(mesh);
